    ...
    <div className='overflow-hidden'>
      <div className='max-w-7xl mx-auto px-10 mt-20'>
        <div className='flex items-center justify-center flex-col'>
          ...
          <p data-aos="fade-left" className='text-gray-300 font-medium text-xl text-center mt-4'>A showcase of the projects I have worked on</p>
        </div>
                ...
                <div>
                  <div className='m-4'>
                    ...
                    <img
                      ...
                      className='w-full rounded-lg h-59'
                    />
                  </div>
                  ...
                  <div className='p-4 flex gap-2 flex-wrap'>
                    {element.tools.map((el, index) => (
                      <p key={index} className='bg-gray-700 text-white px-2 py-1 rounded-md'>{el}</p>
                    ))}
                  </div>
                </div>
