    ...
    <div className='overflow-hidden'>
      <div className='max-w-7xl mx-auto px-10 mt-20'>
        <div className='flex items-center justify-center flex-col mb-20'>
          ...
          <p data-aos="fade-left" className='text-gray-300 font-medium text-xl text-center mt-4'>A glimpse into my learning journey and academic achievements.</p>
        </div>
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className='relative flex w-full mb-20 justify-start'>
            <div data-aos="fade-right" className='w-full sm:w-[46%] bg-gray-900 border border-white/30 hover:border-white/50 rounded-2xl p-6 shadow-[0_0_25px_rgba(130,69,236,0.35)]'>
            ...
            <div className='hidden md:block absolute left-1/2 top-6 -translate-x-1/2 z-5'>
          ...
          <div className='relative flex w-full mb-20 justify-end'>
            <div data-aos="fade-left" className='w-full sm:w-[46%] bg-gray-900 border border-white/30 hover:border-white/50 rounded-2xl p-6 shadow-[0_0_25px_rgba(130,69,236,0.35)]'>
              <div className="flex items-center gap-5">
